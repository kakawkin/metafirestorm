...
const CLASSES = [
  ...
  { id:'demonhunter', api:'DemonHunter', name:'Охотник на демонов', color:'#A330C9', icon:_GH_REPO + '/wow-icons/demonhunter.jpg',
    specs:[{id:'havoc',api:'Havoc',name:'Истребление',role:'dps',icon:_GH_REPO + '/wow-icons/specs/ability_demonhunter_specdps.gif'},{id:'veng',api:'Vengeance',name:'Месть',role:'tank',icon:_GH_REPO + '/wow-icons/specs/ability_demonhunter_spectank.gif'}] },
  { id:'druid',       api:'Druid',       name:'Друид',              color:'#FF7C0A', icon:_GH_REPO + '/wow-icons/druid.jpg',
    specs:[{id:'balance',api:'Balance',name:'Баланс',role:'dps',icon:_GH_REPO + '/wow-icons/specs/spell_nature_starfall.gif'},{id:'feral',api:'Feral',name:'Сила зверя',role:'dps',icon:_GH_REPO + '/wow-icons/specs/ability_druid_catform.gif'},{id:'guardian',api:'Guardian',name:'Страж',role:'tank',icon:_GH_REPO + '/wow-icons/specs/ability_racial_bearform.gif'},{id:'resto',api:'Restoration',name:'Исцеление',role:'heal',icon:_GH_REPO + '/wow-icons/specs/spell_nature_healingtouch.gif'}] },
  { id:'evoker',      api:'Evoker',      name:'Пробудитель',        color:'#33937F', icon:_GH_REPO + '/wow-icons/evoker.jpg',
    specs:[{id:'dev',api:'Devastation',name:'Опустошитель',role:'dps',icon:_GH_REPO + '/wow-icons/specs/classicon_evoker_devastation.gif'},{id:'pres',api:'Preservation',name:'Хранитель',role:'heal',icon:_GH_REPO + '/wow-icons/specs/classicon_evoker_preservation.gif'},{id:'aug',api:'Augmentation',name:'Насыщатель',role:'dps',icon:_GH_REPO + '/wow-icons/specs/classicon_evoker_augmentation.gif'}] },
  { id:'hunter',      api:'Hunter',      name:'Охотник',            color:'#AAD372', icon:_GH_REPO + '/wow-icons/hunter.jpg',
    specs:[{id:'bm',api:'BeastMastery',name:'Повелитель зверей',role:'dps',icon:_GH_REPO + '/wow-icons/specs/ability_hunter_bestialdiscipline.gif'},{id:'mm',api:'Marksmanship',name:'Стрельба',role:'dps',icon:_GH_REPO + '/wow-icons/specs/ability_hunter_focusedaim.gif'},{id:'survival',api:'Survival',name:'Выживание',role:'dps',icon:_GH_REPO + '/wow-icons/specs/ability_hunter_camouflage.gif'}] },
  { id:'mage',        api:'Mage',        name:'Маг',                color:'#3FC7EB', icon:_GH_REPO + '/wow-icons/mage.jpg',
    specs:[{id:'arcane',api:'Arcane',name:'Тайная магия',role:'dps',icon:_GH_REPO + '/wow-icons/specs/spell_holy_magicalsentry.gif'},{id:'fire',api:'Fire',name:'Огонь',role:'dps',icon:_GH_REPO + '/wow-icons/specs/spell_fire_firebolt02.gif'},{id:'frost',api:'Frost',name:'Лёд',role:'dps',icon:_GH_REPO + '/wow-icons/specs/spell_frost_frostbolt02.gif'}] },
  { id:'monk',        api:'Monk',        name:'Монах',              color:'#00FF98', icon:_GH_REPO + '/wow-icons/monk.jpg',
    specs:[{id:'brew',api:'Brewmaster',name:'Хмелевар',role:'tank',icon:_GH_REPO + '/wow-icons/specs/monk_stance_drunkenox.gif'},{id:'mist',api:'Mistweaver',name:'Ткач туманов',role:'heal',icon:_GH_REPO + '/wow-icons/specs/monk_stance_wiseserpent.gif'},{id:'ww',api:'Windwalker',name:'Танцующий с ветром',role:'dps',icon:_GH_REPO + '/wow-icons/specs/monk_stance_whitetiger.gif'}] },
  { id:'paladin',     api:'Paladin',     name:'Паладин',            color:'#F48CBA', icon:_GH_REPO + '/wow-icons/paladin.jpg',
    specs:[{id:'holy',api:'Holy',name:'Свет',role:'heal',icon:_GH_REPO + '/wow-icons/specs/spell_holy_holybolt.gif'},{id:'protection',api:'Protection',name:'Защита',role:'tank',icon:_GH_REPO + '/wow-icons/specs/ability_paladin_shieldofthetemplar.gif'},{id:'retribution',api:'Retribution',name:'Воздаяние',role:'dps',icon:_GH_REPO + '/wow-icons/specs/spell_holy_auraoflight.gif'}] },
  { id:'priest',      api:'Priest',      name:'Жрец',               color:'#FFFFFF', icon:_GH_REPO + '/wow-icons/priest.jpg',
    specs:[{id:'disc',api:'Discipline',name:'Послушание',role:'heal',icon:_GH_REPO + '/wow-icons/specs/spell_holy_powerwordshield.gif'},{id:'holy',api:'Holy',name:'Свет',role:'heal',icon:_GH_REPO + '/wow-icons/specs/spell_holy_guardianspirit.gif'},{id:'shadow',api:'Shadow',name:'Тьма',role:'dps',icon:_GH_REPO + '/wow-icons/specs/spell_shadow_shadowwordpain.gif'}] },
  { id:'rogue',       api:'Rogue',       name:'Разбойник',          color:'#FFF468', icon:_GH_REPO + '/wow-icons/rogue.jpg',
    specs:[{id:'assa',api:'Assassination',name:'Ликвидация',role:'dps',icon:_GH_REPO + '/wow-icons/specs/ability_rogue_eviscerate.gif'},{id:'outlaw',api:'Outlaw',name:'Бой',role:'dps',icon:_GH_REPO + '/wow-icons/specs/ability_rogue_waylay.gif'},{id:'sub',api:'Subtlety',name:'Скрытность',role:'dps',icon:_GH_REPO + '/wow-icons/specs/ability_stealth.gif'}] },
  { id:'shaman',      api:'Shaman',      name:'Шаман',              color:'#0070DD', icon:_GH_REPO + '/wow-icons/shaman.jpg',
    specs:[{id:'ele',api:'Elemental',name:'Стихии',role:'dps',icon:_GH_REPO + '/wow-icons/specs/spell_nature_lightning.gif'},{id:'enh',api:'Enhancement',name:'Совершенствование',role:'dps',icon:_GH_REPO + '/wow-icons/specs/spell_nature_lightningshield.gif'},{id:'resto',api:'Restoration',name:'Исцеление',role:'heal',icon:_GH_REPO + '/wow-icons/specs/spell_nature_magicimmunity.gif'}] },
  { id:'warlock',     api:'Warlock',     name:'Чернокнижник',       color:'#8788EE', icon:_GH_REPO + '/wow-icons/warlock.jpg',
    specs:[{id:'aff',api:'Affliction',name:'Колдовство',role:'dps',icon:_GH_REPO + '/wow-icons/specs/spell_shadow_deathcoil.gif'},{id:'demo',api:'Demonology',name:'Демонология',role:'dps',icon:_GH_REPO + '/wow-icons/specs/spell_shadow_metamorphosis.gif'},{id:'destro',api:'Destruction',name:'Разрушение',role:'dps',icon:_GH_REPO + '/wow-icons/specs/spell_shadow_rainoffire.gif'}] },
  { id:'warrior',     api:'Warrior',     name:'Воин',               color:'#C69B6D', icon:_GH_REPO + '/wow-icons/warrior.jpg',
    specs:[{id:'arms',api:'Arms',name:'Оружие',role:'dps',icon:_GH_REPO + '/wow-icons/specs/ability_warrior_savageblow.gif'},{id:'fury',api:'Fury',name:'Неистовство',role:'dps',icon:_GH_REPO + '/wow-icons/specs/ability_warrior_innerrage.gif'},{id:'protection',api:'Protection',name:'Защита',role:'tank',icon:_GH_REPO + '/wow-icons/specs/ability_warrior_defensivestance.gif'}] },
];
