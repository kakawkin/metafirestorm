...
Чародейские пилоны вокруг комнаты активируются и начинают направлять энергию к боссу.

Если луч не перехвачен игроком, он направляется в Лум’итар, нанося вместо этого урон от тайной магии всему рейду каждую секунду в течение 25 секунд.

Перехватывающий игрок получает накапливающийся периодический урон ([Гипернасыщение](https://www.wowhead.com/ru/spell=1247045)) вместо этого, рекомендуется менять игроков примерно на 5-7 стаках этого дебаффа.

#### Сплетенный оберег

Насыщенные клубки появляются с двумя барьерами, один на внутреннем кольце и один на внешнем, которые предотвращают весь урон, пока не будут ударены [Пронзающая нить](https://www.wowhead.com/ru/spell=1227263).

Это требует двух последовательных танковых ударов, чтобы убрать оба.

#### Насыщающие путы

При истечении дополнительно наносит урон от тайной магии связанному игроку; убедитесь, что здоровье игроков на максимуме перед разрывом Связи.

#### Чародейское возмущение

Когда канал заканчивается, игроки взрываются [Чародейская энергия](https://www.wowhead.com/ru/spell=1242086), нанося урон себе и союзникам в радиусе 6 метров, поэтому разойдитесь.

#### Извилистый покров

Если [Извивающаяся волна](https://www.wowhead.com/ru/spell=1227226) не попадает минимум в 5 игроков, Лум’итар получает накапливающийся щит поглощения урона.
